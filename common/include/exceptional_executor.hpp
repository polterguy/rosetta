...
public:
  ...
  exceptional_executor (std::function<void ()> functor, std::function<void ()> release = nullptr);
...
private:
  ...
  /// Function object that will evaluate when instance is released.
  mutable std::function<void ()> _release;
};
