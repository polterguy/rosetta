...
request_handler_ptr request_handler_factory::create (class connection * connection, class request * request, int status_code)
{
...
bool request_handler_factory::in_whitelist (const class connection * connection, const class request * request)
{
...
bool request_handler_factory::in_blacklist (const class connection * connection, const class request * request)
{
  // Making things more tidy in here.
  using namespace std;
  using namespace boost::algorithm;
...
bool request_handler_factory::should_upgrade_insecure_requests (const class connection * connection, const class request * request)
{
...
request_handler_ptr request_handler_factory::upgrade_insecure_request (class connection * connection, class request * request)
{
...
request_handler_ptr request_handler_factory::create_trace_handler (class connection * connection, class request * request)
{
...
request_handler_ptr request_handler_factory::create_head_handler (class connection * connection, class request * request)
{
...
request_handler_ptr request_handler_factory::create_get_handler (class connection * connection, class request * request)
{
  // Checking that path actually exists.
  if (!exists (request->envelope().path()))
    return request_handler_ptr (new error_handler (connection, request, 404)); // No such path.
...
request_handler_ptr request_handler_factory::create_put_handler (class connection * connection, class request * request)
{
...
request_handler_ptr request_handler_factory::create_delete_handler (class connection * connection, class request * request)
{
  // Checking that path actually exists.
  if (!exists (request->envelope().path()))
    return request_handler_ptr (new error_handler (connection, request, 404)); // No such path.
